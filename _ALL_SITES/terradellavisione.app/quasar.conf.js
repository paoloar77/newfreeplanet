...
module.exports = configure((ctx) => ({
  ...
  pwa: {
    ...
    manifest: {
      ...
      icons: [
        {
          src: 'images/terradellavisione-android-icon-96x96.png',
          sizes: '96x96',
          type: 'image/png',
        },
        {
          src: 'images/terradellavisione-android-icon-144x144.png',
          sizes: '144x144',
          type: 'image/png',
        },
        {
          src: 'images/terradellavisione-android-icon-192x192.png',
          sizes: '192x192',
          type: 'image/png',
        },
        {
          src: 'images/terradellavisione-android-icon-384x384.png',
          sizes: '384x384',
          type: 'image/png',
        },
        {
          src: 'images/terradellavisione-android-icon-512x512.png',
          sizes: '512x512',
          type: 'image/png',
        },
      ],
